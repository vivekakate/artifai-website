  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      */}
                ...
                <div className="space-y-6">
                  ...
                  */}
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <ul className="space-y-3">
                      {['UI/UX & brand design', 'Next.js applications & React components', 'SEO optimization, websites & landing pages', 'Real-time data dashboards & analytics tools', 'Mobile-responsive progressive web apps', 'E-commerce platforms & custom CMS'].map((item, idx) => (
                        <li key={idx} className="flex gap-3 items-start">
      ...
      {/* Real results. Real people. (Testimonials) */}
      <section className="py-32 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
